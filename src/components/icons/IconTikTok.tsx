export const IconTikTok = () => (
  <svg class="icon icon-tabler icon-tabler-brand-tiktok w-5 h-5" width="24px" height="24px" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="currentColor">
